...
<body>
    ...
    <main class="main" id="main">
        ...
        <?php
                    include("db.php");
                    $query = "SELECT * FROM celulares WHERE marca = 'samsung' and modelo = 'a12' and estado = 'muy bueno'";
    ...
    <section class="slider-contenedor">
        <div class="slider-for" id="slider-for">
            ...
            <a
                ...
                data-src="images/s-a12/samsung-a12.png">
                <img class="slider__img slider-img__zoom" src="images/s-a12/samsung-a12-small.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/s-a12/samsung-a12-big-dos.png">
                <img class="slider__img slider-img__zoom" src="images/s-a12/samsung-a12-small-dos.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/s-a12/samsung-a12-big-tres.png">
                <img class="slider__img slider-img__zoom" src="images/s-a12/samsung-a12-small-tres.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/s-a12/samsung-a12-big-cuatro.png">
                <img class="slider__img slider-img__zoom" src="images/s-a12/samsung-a12-small-cuatro.png"/>
            </a>
        ...
        <div class="slider-nav" id="slider-nav">
            ...
            <div>
            <img class="slider__img" src="images/s-a12/samsung-a12-small.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/s-a12/samsung-a12-small-dos.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/s-a12/samsung-a12-small-tres.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/s-a12/samsung-a12-small-cuatro.png" style="width:50%;">
            </div>
    ...
    <section class=""></section>
            ...
            <div id="slider-mobile">
                    <a
                        ...
                        data-src="images/s-a12/samsung-a12.png">
                        <img class="slider__img" src="images/s-a12/samsung-a12-small.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/s-a12/samsung-a12-big-dos.png">
                        <img class="slider__img" src="images/s-a12/samsung-a12-small-tres.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/s-a12/samsung-a12-big-tres.png">
                        <img class="slider__img" src="images/s-a12/samsung-a12-small-dos.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/s-a12/samsung-a12-big-cuatro.png">
                        <img class="slider__img" src="images/s-a12/samsung-a12-small-cuatro.png"/>
                    </a>
            </div>
        ...
        <div class="producto-info">
            ...
            <div class="producto-info-dos">
                ...
                <span class="producto-info__span2"> <?php if($color = "Negro") {
                    echo "Color: <div class='color__black'></div>";
                }
                ?></span>
