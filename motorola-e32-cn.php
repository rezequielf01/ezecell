...
<head>
    ...
    <title>Celular Motorola E32 - EzeCell</title>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <?php
                    include("db.php");
                    $query = "SELECT * FROM celulares WHERE marca = 'motorola' and modelo = 'e32'";
    ...
    <section class="slider-contenedor">
        <div class="slider-for" id="slider-for">
            ...
            <a
                ...
                data-src="images/m-e32/motorola-e32.png">
                <img class="slider__img slider-img__zoom" src="images/m-e32/motorola-e32-small.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/m-e32/motorola-e32-big-dos.png">
                <img class="slider__img slider-img__zoom" src="images/m-e32/motorola-e32-small-dos.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/m-e32/motorola-e32-big-tres.png">
                <img class="slider__img slider-img__zoom" src="images/m-e32/motorola-e32-small-tres.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/m-e32/motorola-e32-big-cuatro.png">
                <img class="slider__img slider-img__zoom" src="images/m-e32/motorola-e32-small-cuatro.png"/>
            </a>
        ...
        <div class="slider-nav" id="slider-nav">
            ...
            <div>
            <img class="slider__img" src="images/m-e32/motorola-e32-small.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/m-e32/motorola-e32-small-dos.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/m-e32/motorola-e32-small-tres.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/m-e32/motorola-e32-small-cuatro.png" style="width:50%;">
            </div>
    ...
    <section class=""></section>
            ...
            <div id="slider-mobile">
                    <a
                        ...
                        data-src="images/m-e32/motorola-e32.png">
                        <img class="slider__img" src="images/m-e32/motorola-e32-small.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/m-e32/motorola-e32-big-dos.png">
                        <img class="slider__img" src="images/m-e32/motorola-e32-small-tres.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/m-e32/motorola-e32-big-tres.png">
                        <img class="slider__img" src="images/m-e32/motorola-e32-small-dos.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/m-e32/motorola-e32-big-cuatro.png">
                        <img class="slider__img" src="images/m-e32/motorola-e32-small-cuatro.png"/>
                    </a>
            </div>
        ...
        <div class="producto-info">
            ...
            <div class="producto-info-dos">
                ...
                <span class="producto-info__span2"> <?php if($color = "Gris") {
                    echo "Color: <div class='color__gray'></div>";
                }
                ?></span>
