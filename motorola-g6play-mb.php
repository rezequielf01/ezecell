...
<body>
    ...
    <main class="main" id="main">
        ...
        <?php
                    include("db.php");
                    $query = "SELECT * FROM celulares WHERE marca = 'motorola' and modelo = 'g6 play'";
    ...
    <section class="slider-contenedor">
        <div class="slider-for" id="slider-for">
            ...
            <a
                ...
                data-src="images/m-g6play/motorola-g6play.png">
                <img class="slider__img slider-img__zoom" src="images/m-g6play/motorola-g6play-small.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/m-g6play/motorola-g6play-big-dos.png">
                <img class="slider__img slider-img__zoom" src="images/m-g6play/motorola-g6play-small-dos.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/m-g6play/motorola-g6play-big-tres.png">
                <img class="slider__img slider-img__zoom" src="images/m-g6play/motorola-g6play-small-tres.png"/>
            </a>

            <a
                data-fancybox="slider-desktop"
                data-src="images/m-g6play/motorola-g6play-big-cuatro.png">
                <img class="slider__img slider-img__zoom" src="images/m-g6play/motorola-g6play-small-cuatro.png"/>
            </a>
        ...
        <div class="slider-nav" id="slider-nav">
            ...
            <div>
            <img class="slider__img" src="images/m-g6play/motorola-g6play-small.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/m-g6play/motorola-g6play-small-dos.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/m-g6play/motorola-g6play-small-tres.png" style="width:50%;">
            </div>

            <div>
            <img class="slider__img" src="images/m-g6play/motorola-g6play-small-cuatro.png" style="width:50%;">
            </div>
    ...
    <section class=""></section>
            ...
            <div id="slider-mobile">
                    <a
                        ...
                        data-src="images/m-g6play/motorola-g6play.png">
                        <img class="slider__img" src="images/m-g6play/motorola-g6play-small.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/m-g6play/motorola-g6play-big-dos.png">
                        <img class="slider__img" src="images/m-g6play/motorola-g6play-small-tres.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/m-g6play/motorola-g6play-big-tres.png">
                        <img class="slider__img" src="images/m-g6play/motorola-g6play-small-dos.png"/>
                    </a>

                    <a
                        data-fancybox="slider-mobile"
                        data-src="images/m-g6play/motorola-g6play-big-cuatro.png">
                        <img class="slider__img" src="images/m-g6play/motorola-g6play-small-cuatro.png"/>
                    </a>
            </div>
